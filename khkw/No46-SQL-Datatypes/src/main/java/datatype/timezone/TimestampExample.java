...
public class TimestampExample {
    ...
    public static void test32bit() {
        System.out.println(Integer.MAX_VALUE / (365*24*3600)); // 约68年
    }
    ...
    public static void offsetDateTime(){
        ...
        OffsetDateTime offsetDateTime = OffsetDateTime.now(ZoneId.of("Asia/Shanghai"));
        String result = dateTimeFormatter.format(offsetDateTime);
        System.out.println(String.format("北京时间: %s", result));

        long lts = offsetDateTime.toEpochSecond()*1000;
        System.out.println(lts);

        TimeZone.setDefault(TimeZone.getTimeZone("GMT+0"));
        Timestamp ts = new Timestamp(lts);
        System.out.println(String.format("UTC时间: %s", ts.toString()));
